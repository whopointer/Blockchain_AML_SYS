...
import { detectionApi, DetectResponse, getRiskLevelColor } from '../services/api';
...
const AddressDetectionForm: React.FC<AddressDetectionFormProps> = ({
      ...
      <Card className="mt-4" style={{
        ...
        <Card.Body>
          ...
          <div className="text-center mb-3">
            ...
            <div className="mt-2">
              <strong style={{ fontSize: '24px', color: getRiskLevelColor(result.risk_label) }}>
            ...
            <div className="mt-3 p-3 bg-light rounded">
              <div className="row text-center">
                <div className="col">
                  ...
                  <div className="fw-bold">{result.subgraph_info.total_nodes}</div>
                </div>
                <div className="col">
                  <div className="text-muted small">边数</div>
                  <div className="fw-bold">{result.subgraph_info.total_edges}</div>
                </div>
                <div className="col">
                  <div className="text-muted small">邻居深度</div>
                  <div className="fw-bold">{result.subgraph_info.neighbor_depth}</div>
                </div>
              </div>
            </div>
          )}
  ...
  return (
    <div className="address-detection-form">
